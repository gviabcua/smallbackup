<?php namespace Gviabcua\SmallBackup\Models;

use Model, Db, Str;
use Gviabcua\SmallBackup\Classes\PathHelper;
...
class Settings extends Model
{
    ...
    public $requiredPermissions = ['gviabcua.smallbackup.access_settings'];

    public $settingsCode = 'gviabcua_smallbackup_settings';
