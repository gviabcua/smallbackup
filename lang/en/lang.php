...
return [
    ...
    'settings' => [
        ...
        'db_auto__comment' => 'The automatic mode is started once a day by the scheduler according to the Winter CMS documentation. Manual mode requires running the process according to the plugin documentation.',
        ...
        'theme_auto__comment' => 'The automatic mode is started once a day by the scheduler according to the Winter CMS documentation. Manual mode requires running the process according to the plugin documentation.',

        'plugins_auto' => 'Switch on auto plugins backup',
        'plugins_auto__comment' => 'The automatic mode is started once a day by the scheduler according to the Winter CMS documentation. Manual mode requires running the process according to the plugin documentation.',

        'storage_auto' => 'Switch on auto storage backup',
        'storage_auto__comment' => 'The automatic mode is started once a day by the scheduler according to the Winter CMS documentation. Manual mode requires running the process according to the plugin documentation.',
