...
use Gviabcua\SmallBackup\Classes\PluginsBackupManager;

class BackupPlugins extends BackupCommand
{
    /**
     * @var string The console command name.
     */
    protected $name = 'smallbackup:plugins';

    /**
     * @var string The console command description.
     */
    protected $description = 'Backup current plugins.';
    ...
    {
        return [
            ['name', InputArgument::OPTIONAL, 'Another name.'],
        ];
    }
}
